        ...
        <div class="card w-75 m-auto p-3 bg-dark text-light">
            ...
            <form action="<?php  echo base_url('admin/aksi_ubah_akun')?>" method="post" class="row" enctype="multipart/form-data">
                <div class="mb-3 col-6">
                    ...
                    <input type="text" value="<?php echo $users->email ?>" class="form-control" id="nama" name="email">
                </div>
                <div class="mb-3 col-6">
                    <label for="nama" class="form-label">Username</label>
                    <input type="text" class="form-control" value="<?php echo $users->username?>" id="nisn" name="username">
                </div>
                <div class="mb-3 col-6">
                    <label for="nama" class="form-label">Password Baru</label>
                    <input type="text" class="form-control" value="" id="nisn" name="password_baru">
                </div>
                <div class="mb-3 col-6">
                    <label for="nama" class="form-label">Konfirmasi Password Baru</label>
                    <input type="text" class="form-control" value="" id="nisn" name="konfirmasi_password">
                </div>
